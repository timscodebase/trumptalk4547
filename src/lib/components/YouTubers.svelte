...
<section>
	{#each you_tubers as you_tuber}
		<article>
			<a href={you_tuber.url} target="_blank" rel="noopener noreferrer">
				<img src={you_tuber.image} alt={you_tuber.name} loading="lazy" />
				<h3>{you_tuber.name}</h3>
			</a>
			<p>{you_tuber.description}</p>
		</article>
	{/each}
</section>
